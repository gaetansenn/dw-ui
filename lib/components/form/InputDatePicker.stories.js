...
const Template = (args, { argTypes }) => ({
  ...
  template: '<DwInputDatePicker v-model="value" name="input-datepicker" :rounded="rounded" :locale="$i18n.locale" :variant="variant" :label="label" :size="size" :required="required" :inline="inline" :help="help" :validation="validation" :placeholder="placeholder" :format="format" :loading="loading" />'
})
