...
const TemplateConfirm = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  template: `<form>
    <DwInputPassword v-model="value" :same="confirm" ref="input" name="input-password" :variant="variant" :size="size" :required="true" :inline="inline" :help="help" :validation="validation" label="Your password" autocomplete="current-password" eye />
    <DwInputPassword v-model="confirm" name="input-confirm" class="mt-5" :variant="variant" :size="size" :required="true" :inline="inline" :help="help" :validation="validation" label="Confirm your password" autocomplete="new-password" eye /><br>
