...
const Template = (args, { argTypes }) => ({
  ...
  template: '<DwInputPassword v-model="value" name="input-password" :rounded="rounded" :variant="variant" :label="label" :size="size" :required="required" :inline="inline" :help="help" :help-tooltip="helpTooltip" :validation="validation" :placeholder="placeholder" />'
})

const TemplateValidation = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  template: '<div><DwInputPassword v-model="value" ref="input" name="input-password" :rounded="rounded" :variant="variant" :label="label" :size="size" :required="required" :inline="inline" :help="help" :validation="validation" :validate-password="validatePassword" required /><br><DwButton @click.native="$refs.input.validate()">Submit</DwButton></div>'
})
