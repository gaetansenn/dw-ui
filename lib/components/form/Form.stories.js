...
const Template = (args, { argTypes }) => ({
  ...
  template: `<DwForm :submit="onSubmit" :form="form">
    <DwInputText v-model="form.sameNameAsAttribute" name="sameNameAsAttribute" label="My form" required />
...
const CustomFieldsTemplate = (args, { argTypes }) => ({
  ...
  template: `<DwForm :submit="onSubmit" :form="form" :fields="fields">
    <DwInputText v-model="form.sameNameAsAttribute" name="signupName" label="My form" required />
    <DwButton type="submit" class="mt-5">Submit</DwButton>
  </DwForm>`,
  methods: {
    onSubmit () {
