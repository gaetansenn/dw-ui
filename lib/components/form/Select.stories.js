...
const Template = (args, { argTypes }) => ({
  ...
  template: '<div><DwSelect v-model="value" name="input-text" :rounded="rounded" :placeholder="placeholder" :variant="variant" :options="options" :label="label" :size="size" :required="required" :inline="inline" :help="help" :validation="validation" :value-key="valueKey" :disabled="disabled" /><div class="mt-5">Selected : {{ value }}</div></div>'
})
