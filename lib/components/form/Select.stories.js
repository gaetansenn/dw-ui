...
const Template = (args, { argTypes }) => ({
  ...
  template: '<DwSelect v-model="value" name="input-text" :rounded="rounded" :placeholder="placeholder" :variant="variant" :options="options" :label="label" :size="size" :required="required" :inline="inline" :help="help" :validation="validation" />'
})
