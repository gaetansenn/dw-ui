...
const TemplateConfirm = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  template: `<div>
    <DwInputEmail v-model="value" :confirm="$refs.confirm" ref="input" name="input-email" :variant="variant" :size="size" :required="true" :inline="inline" :help="help" :validation="validation" label="Your Email" />
    <DwInputEmail v-model="confirm" ref="confirm" name="input-confirm" class="mt-5" :variant="variant" :size="size" :required="true" :inline="inline" :help="help" :validation="validation" label="Confirm your Email" /><br>
