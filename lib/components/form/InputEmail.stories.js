...
const Template = (args, { argTypes }) => ({
  ...
  template: '<DwInputEmail v-model="value" name="input-text" :variant="variant" :label="label" :size="size" :required="required" :inline="inline" :help="help" :validation="validation" />'
})
