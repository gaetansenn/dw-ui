    ...
    DatePicker: {
      ...
      header: {
        ...
        navigation: {
          ...
          icon: {
            fixed: 'w-4 h-4',
            left: '<svg viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.54282 0.542969L8.95703 1.95718L3.16414 7.75008L8.95703 13.543L7.54282 14.9572L0.335711 7.75008L7.54282 0.542969Z" fill="currentColor" /></svg>',
            right: '<svg viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M1.45718 14.957L0.0429687 13.5428L5.83586 7.74992L0.0429682 1.95703L1.45718 0.542818L8.66429 7.74992L1.45718 14.957Z" fill="currentcolor" /></svg>'
          }
        }
      }
    },
    ...
    i18n: {
      en: {
        ...
        InputPassword: {
          ...
          valid: 'Your password should contain '
        },
        InputDate: {
          valid: 'Please provide a valid date'
        },
