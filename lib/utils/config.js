...
export default function () {
  ...
  const defaultConfig = {
    ...
    ItemQuantity: {
      wrapper: 'inline-flex font-zilla leading-none items-center select-none p-3 border border-gray-300 rounded-full',
      fixed: 'px-3 font-bold min-w-12 text-center',
      remove: {
        fixed: 'border border-black rounded-full p-2 hover:bg-gray-100 focus:outline-none focus:shadow-outline',
        icon: '<svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd" /></svg>'
      },
      add: {
        fixed: 'border border-black rounded-full p-2 hover:bg-gray-100 focus:outline-none focus:shadow-outline',
        icon: '<svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd" /></svg>'
      }
    },
    build: {}
  };
