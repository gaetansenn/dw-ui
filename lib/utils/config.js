...
export default function () {
  ...
  ['InputText', 'InputEmail', 'InputPassword', 'InputRadio', 'InputDate', 'InputDatePicker', 'InputCheckbox', 'TextArea', 'InputTime', 'InputNumber'].forEach(parentPath => mergeClasses(Input, parentPath, 'Input', defaultConfig, newConfig))
