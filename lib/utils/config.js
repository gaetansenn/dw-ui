...
export default function () {
  ...
  ['InputText', 'InputEmail', 'InputPassword', 'InputRadio', 'InputDate', 'InputDatePicker', 'InputCheckbox', 'TextArea', 'InputTime'].forEach(parentPath => mergeClasses(Input, parentPath, 'Input', defaultConfig, newConfig))
